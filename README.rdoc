...
In order to make the app's guesses improve over time, I used LIBSVM, a library for Support Vector Machines (http://www.csie.ntu.edu.tw/~cjlin/libsvm/). Specifically, I used the Ruby port of the LIBSVM Python SWIG (Simplified Wrapper and Interface Generator) found at https://github.com/tomz/libsvm-ruby-swig/tree/master. When time permits, I'd like to investigate the inner workings of LIBSVM moving forward and preprocess my data to improve accuracy.
